...
+(BOOL) stringIsIPV4RawStr:(nonnull NSString *)pRawStr
{
    BOOL rRes=false;
    NSError * err=NULL;
    NSString * pattern=@"^(25[0-5]|2[0-4][0-9]|[0-1]{1}[0-9]{2}|[1-9]{1}[0-9]{1}|[1-9])\\.(25[0-5]|2[0-4][0-9]|[0-1]{1}[0-9]{2}|[1-9]{1}[0-9]{1}|[1-9]|0)\\.(25[0-5]|2[0-4][0-9]|[0-1]{1}[0-9]{2}|[1-9]{1}[0-9]{1}|[1-9]|0)\\.(25[0-5]|2[0-4][0-9]|[0-1]{1}[0-9]{2}|[1-9]{1}[0-9]{1}|[0-9]):\\d{0,6}$";
    ...
    if(![@"" isEqualToString:pRawStr]&&pRawStr!=nil)
    {
        NSUInteger count= [regex numberOfMatchesInString:pRawStr options:0 range:NSMakeRange(0, [pRawStr length])];
        if (count==1) {
            rRes=true;
        }
    }else{
        ...
        }else
        {
            ...
            else
            {
                ...
                //websocket
                    ...
                    pDealStr=pRawStr;
                //不认识的字符串
                }else if ([[self class] stringIsIPV4RawStr:pRawStr]) {
                    rWatchQRCodeType=WatchQRCodeTypeIpV4;
                    pDealStr=pRawStr;
                    //不认识的字符串
                }
                else
...
+(NSMutableArray *) testWatchQRCodeTypeArray
{
    ...
    [tArray addObject:@"192.168.1.100:1000"];
     [tArray addObject:@""];
    return tArray;
